...
// Local database URI.
const LOCAL_DATABASE = "mongodb+srv://testuser:asd123@cluster0.dqjqu.mongodb.net/fashionapp?retryWrites=true&w=majority";  //your url
// Local port.
...
app.post("/api/users", function (req, res){
    ...
    if(!user.username){
        ...
        manageError(res, "Invalid user email", "Email is mandatory.", 400)
    }else{
